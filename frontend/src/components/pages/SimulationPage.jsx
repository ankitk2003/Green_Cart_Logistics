  ...
  return (
    <div style={{ maxWidth: 600, margin: 'auto', padding: 20 }}>
      ...
      <form onSubmit={handleSubmit}>
        <div>
          <label>Number of Available Drivers:</label><br />
          <input
            type="number"
        ...
        <div>
          <label>Route Start Time:</label><br />
          <input
            type="time"
            name="routeStartTime"
        ...
        <div>
          <label>Max Hours Per Driver Per Day:</label><br />
          <input
            type="number"
        ...
        <button className="bg-amber-300 p-2 rounded-4xl text-blue-400"type="submit" disabled={loading}>
      ...
      {results && (
        <div style={{ marginTop: 20 }}>
          ...
          <p><strong>Total Profit:</strong> {results.totalProfit}</p>
          <p><strong>Efficiency Score:</strong> {results.efficiency}</p>
          <p><strong>On-time Deliveries:</strong> {results.onTimeDeliveries}</p>
          <p><strong>Late Deliveries:</strong> {results.lateDeliveries}</p>
          <p><strong>Fuel Cost Breakdown:</strong> {results.fuelCostBreakdown}</p>
